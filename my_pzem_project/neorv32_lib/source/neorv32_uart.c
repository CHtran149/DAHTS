...
// void neorv32_uart_print_float(neorv32_uart_t *UARTx, float value, int precision) {
//     // 1. In phần nguyên
//     int32_t int_part = (int32_t)value;
//     neorv32_uart_printf(UARTx, "%d", int_part);

//     // 2. In dấu chấm thập phân
//     neorv32_uart_putc(UARTx, '.');
...
//     // Nhân để đưa các số thập phân cần in lên trước dấu phẩy
//     for(int i = 0; i < precision; i++) {
//         remainder *= 10;
//     }
    
//     // In phần thập phân đã xử lý
//     neorv32_uart_printf(UARTx, "%u", (uint32_t)remainder);
// }
